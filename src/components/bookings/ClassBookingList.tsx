...
export const ClassBookingList: React.FC<ClassBookingListProps> = ({
  searchTerm,
  modalityFilter,
}) => {
  ...
  const toggleFavorite = (classId: number) => {
    console.log('Toggle favorite:', classId);
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <h2 className="text-xl font-semibold">
          Aulas Disponíveis ({filteredClasses.length})
        </h2>
      </div>
              ...
              <div className="grid grid-cols-2 gap-4 mb-4 p-3 bg-muted/50 rounded-lg">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <div>
                    ...
                    <p className="font-medium text-sm">
                      {classItem.capacity - classItem.booked}/{classItem.capacity}
                    </p>
                  </div>
                </div>
